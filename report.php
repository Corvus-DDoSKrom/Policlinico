...
<head>
    ...
    <link rel="stylesheet" href="https://github.com/Corvus-DDoSKrom/Policlinico/blob/main/assets/css/report.css">
...
<body>
    ...
    <fieldset class="form-9">
        ...
        <div class="div-4">
            ...
            <div class="div-5">
                <label class="controls-10" for="cedula">CEDULA</label>
                <input class="controls-9" type="number" name="ci_patient" id="cedula" value="<?php echo $view['ci_patient']; ?>">
            </div> <!--FIN DE CEDULA PACIENTE-->
            <div class="div-5">
                <label class="controls-10" for="age">EDAD</label>
                <input class="controls-9" type="text" name="age" id="age" value="<?php echo $view['age']; ?>">
            </div>
            <div class="div-5">
                <label class="controls-10" for="sex">SEXO</label>
    ...
    <fieldset class="form-9" style="margin-bottom: 15px;">
        <div>
        ...
        <div class="div-4">
            <div class="div-5">
                <label class="controls-10" for="cie10">CIE10</label>
                <input class="controls-9" type="text" name="cie10_consulta" value="<?php echo $view['cie10_consulta']; ?>">
            </div>
            <div class="div-5">
                <label class="controls-10" for="proxima">PROXIMA CONSULTA</label>
                <input class="controls-2" type="text" name="proxima_consulta" value="<?php echo $view['fecha']; ?>">
            </div>
        </div>
    </fieldset>
</body>
...
$options->set(array('isTemoteEnabled' => true));
